...
-- Estaciones climaticas (factor de ajuste sobre E_INV_BASE)
INSERT INTO estaciones (nombre, factor, descripcion) VALUES
('Seca', 1.00, 'Temporada seca (abril-septiembre). Mejor rendimiento del ganado.'),
('Lluviosa', 0.70, 'Temporada lluviosa (diciembre-marzo). Menor rendimiento del ganado.'),
('Transicion', 0.85, 'Transicion (octubre-noviembre). Rendimiento moderado.');
...
('Invernal', 0.75, 'Vaca flaca en invierno (mayo-agosto), rendimiento al 75%.');
...
('A', 'Operacion Optima (Clima Soleado)',
 'Clima soleado, sin bloqueos, condicion buena, estacion seca. Escenario de referencia para maximizar rentabilidad.',
...
('B', 'Contingencia Climatica (Lluvia en Abapo)',
 'Alta probabilidad de lluvia en Abapo que bloquea ruta Ipati-Abapo. Evalua redireccion forzada a rutas asfaltadas.',
...
('C', 'Estacionalidad Invernal (Vaca Flaca)',
 'Invierno con ganado en condicion invernal y precios bajos. Simula el fenomeno de vaca flaca (mayo-agosto).',
...
('D', 'Fluctuacion de Mercado (Alza en Cochabamba)',
 'Incremento del precio en Cochabamba para evaluar sensibilidad. ¿Compensa el mayor costo de flete?',
...
('E', 'Restriccion de Ruta (Bloqueo Total)',
 'Bloqueos en rutas alternativas (R2 y R4). Prueba asignacion forzada a rutas Santa Cruz unicamente.',
...
('F', 'Crisis Logistica (Bloqueo + Clima + Invierno)',
 'Peor escenario combinado: bloqueo en Samaipata, clima adverso en Abapo, condicion invernal y precios bajos.',
