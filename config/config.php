...
// Base de datos (lee variables de entorno en produccion, usa locales por defecto)
if (!defined('DB_HOST')) {
...
if (!defined('DB_PASS')) {
define('DB_PASS', getenv('DB_PASS') !== false ? getenv('DB_PASS') : '68387186');
}
if (!defined('DB_NAME')) {
define('DB_NAME', getenv('DB_NAME') ?: 'dss_agaprova');
}
if (!defined('DB_PORT')) {
...
define('APP_SLOGAN', 'Optimizacion Logistica para Ganado Bovino');
}
